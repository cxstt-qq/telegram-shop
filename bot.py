...
from handlers.admin import admin_main, categories, products, catalog_manager, users_man, stats, mailing, notifications, referrals
...
async def main():
    ...
    dp.include_router(catalog_manager.router)
